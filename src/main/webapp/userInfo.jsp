    ...
    <section class="col-md-4 col-md-offset-4">
        <form action="user?action=updateUserInfo" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input id="avatar" type="file" name="avatar" class="form-control" value="${sessionScope.userInfo.avatar}" ><br>
                <img class="img-circle" style="width: 50px;" src="avatar/${sessionScope.userInfo.avatar}">
            </div>
            <div class="form-group">
